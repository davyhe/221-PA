...
int main() {
    ...
    newcollection.insert_item(Stress_ball(Stress_ball_colors::green, Stress_ball_sizes::large));
    newcollection.insert_item(Stress_ball(Stress_ball_colors::red, Stress_ball_sizes::small));
    newcollection.insert_item(Stress_ball(Stress_ball_colors::blue, Stress_ball_sizes::large));
    newcollection.insert_item(Stress_ball(Stress_ball_colors::yellow, Stress_ball_sizes::medium));

    cout<<"Before remove an random item from the array: \n"<<newcollection;
    cout<<"\nRemove item: "<<newcollection.remove_any_item()<<endl;
    cout<<"After remove an random item from the array: \n"<<newcollection;
    */
